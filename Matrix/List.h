...
void moveNext(List L);                  // If cursor is defined and not at back, move cursor one
                                        ...
                                        // do nothing
void prepend(List L, void* pData);         // Insert new element into L. If L is non-empty,
                                        // insertion takes place before front element.
void append(List L, void* pData);          // Insert new element into L. If L is non-empty,
                                        // insertion takes place after back element.
void insertBefore(List L, void* pData);    // Insert new element before cursor.
                                        // Pre: length()>0, index()>=0
void insertAfter(List L, void* pData);     // Insert new element after cursor.
                                        // Pre: length()>0, index()>=0
